...
</style></head><body><header><h1>LinPEAS Atlas</h1><p>Organize LinPEAS results by section and quickly investigate important signals.</p></header><div class="layout"><aside><div class="toolbar"><label class="upload">+ Upload result file<input id="file" type="file" accept=".txt,.log,.json,text/plain,application/json"></label><input id="search" placeholder="Search this category"><div class="color-filters" id="colorFilters"></div><div class="tactic-filters" id="tacticFilters"></div><button id="download" class="download">Download structured JSON</button></div><nav class="nav" id="nav"></nav></aside><main class="content"><div class="eyebrow" id="scope">Analysis results</div><div class="summary" id="summary"></div><div id="view"><div class="empty">Upload a result file to view the analysis.</div></div></main></div>
<script>
